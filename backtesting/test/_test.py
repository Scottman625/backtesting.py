...
class TestPlot(TestCase):
        ...
        class S(Strategy):
            ...
            def next(self):
                ...
                if date == pd.Timestamp("Thu 19 Oct 2006"):
                    ...
                    self.sell(
                        stop=self.data.Low, limit=324.90, size=200  # High from 14 Nov
                    )
    ...
    def test_resample(self):
        ...
        with _tempfile() as f, patch(
            backtesting._plotting, "_MAX_CANDLES", 10
...
class TestDocs(TestCase):
    ...
    @unittest.skipIf(
        "win" in sys.platform,
        "Locks up with `ModuleNotFoundError: No module named '<run_path>'`",
    )
